...
Dog::Dog() : Animal("Dog") {_dogBrain = new Brain(); std::cout << "DOG Constructor Called." << std::endl;}
Dog::Dog(const Dog &copy) : Animal(copy) {_dogBrain = new Brain(*copy._dogBrain); std::cout << "DOG Copy Constructor Called." << std::endl;}
